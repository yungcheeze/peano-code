...
peano::heap::records::IntegerHeapDataPacked peano::heap::records::IntegerHeapData::convert() const{
   ...
   void peano::heap::records::IntegerHeapData::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
   ...
   void peano::heap::records::IntegerHeapData::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
...
peano::heap::records::IntegerHeapData peano::heap::records::IntegerHeapDataPacked::convert() const{
   ...
   void peano::heap::records::IntegerHeapDataPacked::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   void peano::heap::records::IntegerHeapDataPacked::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
