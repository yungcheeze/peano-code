...
peano::heap::records::IntegerHeapDataPacked peano::heap::records::IntegerHeapData::convert() const{
   ...
   void peano::heap::records::IntegerHeapData::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
...
void peano::heap::records::IntegerHeapData::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
   if (communicateBlocking) {
...
int peano::heap::records::IntegerHeapData::getSenderRank() const {
...
void peano::heap::records::IntegerHeapDataPacked::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
   _senderDestinationRank = destination;
...
void peano::heap::records::IntegerHeapDataPacked::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
if (communicateBlocking) {
...
int peano::heap::records::IntegerHeapDataPacked::getSenderRank() const {
assertion( _senderDestinationRank!=-1 );
return _senderDestinationRank;
