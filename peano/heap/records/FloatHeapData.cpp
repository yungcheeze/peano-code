...
peano::heap::records::FloatHeapDataPacked peano::heap::records::FloatHeapData::convert() const{
   ...
   void peano::heap::records::FloatHeapData::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
...
void peano::heap::records::FloatHeapData::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
   if (communicateBlocking) {
...
int peano::heap::records::FloatHeapData::getSenderRank() const {
...
void peano::heap::records::FloatHeapDataPacked::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
   _senderDestinationRank = destination;
...
void peano::heap::records::FloatHeapDataPacked::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
if (communicateBlocking) {
...
int peano::heap::records::FloatHeapDataPacked::getSenderRank() const {
assertion( _senderDestinationRank!=-1 );
return _senderDestinationRank;
