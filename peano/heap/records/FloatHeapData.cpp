...
peano::heap::records::FloatHeapDataPacked peano::heap::records::FloatHeapData::convert() const{
   ...
   void peano::heap::records::FloatHeapData::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
   ...
   void peano::heap::records::FloatHeapData::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
...
peano::heap::records::FloatHeapData peano::heap::records::FloatHeapDataPacked::convert() const{
   ...
   void peano::heap::records::FloatHeapDataPacked::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   void peano::heap::records::FloatHeapDataPacked::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
