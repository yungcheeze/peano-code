#include "peano/heap/records/MetaInformation.h"
   ...
   peano::heap::records::MetaInformationPacked peano::heap::records::MetaInformation::convert() const{
      ...
      void peano::heap::records::MetaInformation::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
   ...
   void peano::heap::records::MetaInformation::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
      if (communicateBlocking) {
...
peano::heap::records::MetaInformation peano::heap::records::MetaInformationPacked::convert() const{
   ...
   void peano::heap::records::MetaInformationPacked::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
      _senderDestinationRank = destination;
...
void peano::heap::records::MetaInformationPacked::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
   if (communicateBlocking) {
