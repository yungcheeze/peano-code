#include "peano/heap/records/MetaInformation.h"
   ...
   peano::heap::records::MetaInformationPacked peano::heap::records::MetaInformation::convert() const{
      ...
      void peano::heap::records::MetaInformation::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
      ...
      void peano::heap::records::MetaInformation::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
         MPI_Request* sendRequestHandle = new MPI_Request();
         MPI_Status   status;
         int          flag = 0;
         int          result;
   ...
   peano::heap::records::MetaInformation peano::heap::records::MetaInformationPacked::convert() const{
      ...
      void peano::heap::records::MetaInformationPacked::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
         MPI_Request* sendRequestHandle = new MPI_Request();
         MPI_Status   status;
         int          flag = 0;
         int          result;
      ...
      void peano::heap::records::MetaInformationPacked::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
         MPI_Request* sendRequestHandle = new MPI_Request();
         MPI_Status   status;
         int          flag = 0;
         int          result;
