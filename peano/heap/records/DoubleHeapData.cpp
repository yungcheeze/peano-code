...
peano::heap::records::DoubleHeapDataPacked peano::heap::records::DoubleHeapData::convert() const{
   ...
   void peano::heap::records::DoubleHeapData::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
   ...
   void peano::heap::records::DoubleHeapData::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
...
peano::heap::records::DoubleHeapData peano::heap::records::DoubleHeapDataPacked::convert() const{
   ...
   void peano::heap::records::DoubleHeapDataPacked::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
   ...
   void peano::heap::records::DoubleHeapDataPacked::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise) {
      MPI_Request* sendRequestHandle = new MPI_Request();
      MPI_Status   status;
      int          flag = 0;
      int          result;
