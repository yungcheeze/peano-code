...
peano::heap::records::DoubleHeapDataPacked peano::heap::records::DoubleHeapData::convert() const{
   ...
   void peano::heap::records::DoubleHeapData::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
...
void peano::heap::records::DoubleHeapData::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
   if (communicateBlocking) {
...
int peano::heap::records::DoubleHeapData::getSenderRank() const {
...
void peano::heap::records::DoubleHeapDataPacked::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
   _senderDestinationRank = destination;
...
void peano::heap::records::DoubleHeapDataPacked::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
if (communicateBlocking) {
...
int peano::heap::records::DoubleHeapDataPacked::getSenderRank() const {
assertion( _senderDestinationRank!=-1 );
return _senderDestinationRank;
