...
tarch::plotter::griddata::blockstructured::PeanoPatchFileWriter::CellDataWriter::CellDataWriter(
...
void tarch::plotter::griddata::blockstructured::PeanoPatchFileWriter::CellDataWriter::plotCell( int index, double value ) {
  _out << " " << value;
...
void tarch::plotter::griddata::blockstructured::PeanoPatchFileWriter::CellDataWriter::plotCell( int index, const tarch::la::Vector<2,double>& value ) {
...
void tarch::plotter::griddata::blockstructured::PeanoPatchFileWriter::CellDataWriter::plotCell( int index, const tarch::la::Vector<3,double>& value ) {
...
void tarch::plotter::griddata::blockstructured::PeanoPatchFileWriter::CellDataWriter::plotCell( int index, double* values, int numberOfValues ) {
...
void tarch::plotter::griddata::blockstructured::PeanoPatchFileWriter::CellDataWriter::close() {
}


void tarch::plotter::griddata::blockstructured::PeanoPatchFileWriter::CellDataWriter::flushIfPatchIsComplete() {
...
void tarch::plotter::griddata::blockstructured::PeanoPatchFileWriter::CellDataWriter::assignRemainingCellsDefaultValues() {
