...
//#include <iomanip>
//
//tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::CellDataWriter::CellDataWriter(
...
//  _out << std::endl;
//  _out << "<DataArray Name=\"" << dataIdentifier << "\" NumberOfComponents=\"" << _recordsPerCell << "\" format=\"ascii\" type=\"Float32\">" << std::endl;
//#ifdef Parallel
//  _outPVTU << "<PDataArray Name=\"" << dataIdentifier << "\" NumberOfComponents=\"" << _recordsPerCell << "\" format=\"ascii\" type=\"Float32\"/>" << std::endl;
//#endif
//  }
//  else {
//     _out << std::endl;
...
//
//
//void tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::CellDataWriter::close() {
...
//  if (_lastWriteCommandCellNumber>=-1) {
//    _out << std::endl;
//    _myWriter._cellDataDescription += _out.str() + "</DataArray>";
//#ifdef Parallel
...
//
//
//void tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::CellDataWriter::plotCell( int index, double value ) {
...
//
//
//void tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::CellDataWriter::plotCell( int index, const tarch::la::Vector<2,double>& value ) {
//  assertion(_lastWriteCommandCellNumber>=-1);
...
//
//
//void tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::CellDataWriter::plotCell( int index, const tarch::la::Vector<3,double>& value ) {
//  assertion(_lastWriteCommandCellNumber>=-1);
...
//
//
//double tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::CellDataWriter::getMinValue() const {
//  return _minValue;
//}
//
//
//double tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::CellDataWriter::getMaxValue() const {
//  return _maxValue;
//}
