...
//#include <iomanip>
//
//tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::VertexDataWriter::VertexDataWriter(
//  const std::string& dataIdentifier, VTUTextFileWriter& writer, int recordsPerVertex
//):
...
//	  _out << std::endl;
//	  _out << "<DataArray Name=\"" << dataIdentifier << "\" NumberOfComponents=\"" << _recordsPerVertex << "\" format=\"ascii\" type=\"Float32\">";
//#ifdef Parallel
//	  _outPVTU << "<PDataArray Name=\"" << dataIdentifier << "\" NumberOfComponents=\"" << _recordsPerVertex << "\" format=\"ascii\" type=\"Float32\"/>" << std::endl;
//#endif
//  }
//  else {
//     _out << std::endl;
//	  _out << "<DataArray Name=\"" << dataIdentifier << "\" NumberOfComponents=\"3\" format=\"ascii\" type=\"Float32\">" << std::endl ;
//#ifdef Parallel
//	  _outPVTU << "<PDataArray Name=\"" << dataIdentifier << "\" NumberOfComponents=\"3\" format=\"ascii\" type=\"Float32\"/>" << std::endl;
//#endif
//  }
//
//  #ifdef Asserts
...
//
//
//void tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::VertexDataWriter::close() {
...
//  if (_lastWriteCommandVertexNumber>=-1) {
//    _out << std::endl;
//    _myWriter._vertexDataDescription += _out.str() + "</DataArray>";
//#ifdef Parallel
...
//
//
//void tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::VertexDataWriter::plotVertex( int index, double value ) {
...
//
//
//void tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::VertexDataWriter::plotVertex( int index, const tarch::la::Vector<2,double>& value ) {
//  assertion(_lastWriteCommandVertexNumber>=-1);
...
//
//
//void tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::VertexDataWriter::plotVertex( int index, const tarch::la::Vector<3,double>& value ) {
//  assertion(_lastWriteCommandVertexNumber>=-1);
...
//
//
//double tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::VertexDataWriter::getMinValue() const {
//  return _minValue;
//}
//
//
//double tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::VertexDataWriter::getMaxValue() const {
//  return _maxValue;
//}
