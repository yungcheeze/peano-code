...
//#include <iomanip>
//
//tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::VertexWriter::VertexWriter(VTUTextFileWriter& writer):
...
//
//
//tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::VertexWriter::~VertexWriter() {
...
//
//
//int tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::VertexWriter::plotVertex(const tarch::la::Vector<2,double>& position) {
...
//
//
//int tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::VertexWriter::plotVertex(const tarch::la::Vector<3,double>& position) {
...
//
//
//void tarch::plotter::griddata::unstructured::vtu::VTUTextFileWriter::VertexWriter::close() {
//  assertion( _myWriter._numberOfVertices==0 );
