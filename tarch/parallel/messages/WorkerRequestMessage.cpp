...
tarch::parallel::messages::WorkerRequestMessagePacked tarch::parallel::messages::WorkerRequestMessage::convert() const{
   ...
   void tarch::parallel::messages::WorkerRequestMessage::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
...
void tarch::parallel::messages::WorkerRequestMessage::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
   if (communicateBlocking) {
...
void tarch::parallel::messages::WorkerRequestMessagePacked::send(int destination, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
   _senderDestinationRank = destination;
...
void tarch::parallel::messages::WorkerRequestMessagePacked::receive(int source, int tag, bool exchangeOnlyAttributesMarkedWithParallelise, bool communicateBlocking) {
if (communicateBlocking) {
